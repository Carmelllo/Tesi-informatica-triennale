...
\newglossaryentry{aws-bedrock}{
    name={AWS Bedrock},
    text={AWS Bedrock},
    sort=aws-bedrock,
    description={\emph{AWS Bedrock} è un servizio cloud di Amazon Web Services che fornisce accesso a modelli di intelligenza artificiale generativa di diversi provider (come Anthropic, Meta, AI21 Labs) attraverso un'API unificata, semplificando l'integrazione di funzionalità AI nelle applicazioni.}
}
...
\newglossaryentry{react}{
    ...
    text={React},
    sort=react,
    description={\emph{React} è una libreria JavaScript open source sviluppata da Meta (Facebook) per la creazione di interfacce utente. Utilizza un'architettura basata su componenti riutilizzabili e un DOM virtuale per ottimizzare le prestazioni delle applicazioni web.}
}
...
\newglossaryentry{mongodb}{
    ...
    text={MongoDB},
    sort=mongodb,
    description={\emph{MongoDB} è un database NoSQL orientato ai documenti che utilizza il formato BSON per archiviare dati in modo flessibile. È progettato per applicazioni che richiedono scalabilità orizzontale e gestione di grandi volumi di dati non strutturati.}
}

\newglossaryentry{litellm}{
    name={LiteLLM},
    text={LiteLLM},
    sort=litellm,
    description={\emph{LiteLLM} è una libreria Python leggera che fornisce un'interfaccia unificata per interagire con diversi provider di modelli di linguaggio (OpenAI, Anthropic, AWS Bedrock, ecc.), normalizzando le chiamate API in un formato standard compatibile con OpenAI.}
}
...
\newglossaryentry{docker}{
    ...
    text={Docker},
    sort=docker,
    description={\emph{Docker} è una piattaforma di containerizzazione che permette di creare, distribuire e eseguire applicazioni in ambienti isolati chiamati container, garantendo la portabilità e la consistenza tra diversi sistemi.}
}
...
\newglossaryentry{nosql}{
    ...
    text={NoSQL},
    sort=nosql,
    description={I database \emph{NoSQL} (Not Only SQL) sono sistemi di gestione dati che non seguono il modello relazionale tradizionale. Includono database orientati ai documenti, chiave-valore, a colonne e a grafo, offrendo maggiore flessibilità e scalabilità per dati non strutturati.}
}
...
\newglossaryentry{scrum}{
    ...
    text={Scrum},
    sort=scrum,
    description={\emph{Scrum} è un framework agile per la gestione di progetti software che prevede iterazioni di durata fissa (Sprint), ruoli definiti (Scrum Master, Product Owner, Development Team) e cerimonie regolari (daily standup, sprint planning, retrospective).}
}
...
\newglossaryentry{kanban}{
    ...
    text={Kanban},
    sort=kanban,
    description={\emph{Kanban} è un metodo di gestione del lavoro di origine giapponese che enfatizza il flusso continuo delle attività, la visualizzazione del lavoro tramite board e la limitazione del work-in-progress per ottimizzare l'efficienza del team.}
}
...
\newglossaryentry{waterfall}{
    ...
    text={Waterfall},
    sort=waterfall,
    description={Il modello \emph{Waterfall} (a cascata) è una metodologia di sviluppo software sequenziale in cui le fasi (analisi, progettazione, implementazione, test, rilascio) vengono eseguite in ordine rigido senza possibilità di tornare a fasi precedenti.}
}
...
\newglossaryentry{timebox}{
    ...
    text={timebox},
    sort=timebox,
    description={Un \emph{timebox} è un periodo di tempo fisso e predefinito dedicato a un'attività o iterazione di sviluppo. Al termine del timebox, si valuta ciò che è stato completato indipendentemente dal raggiungimento di tutti gli obiettivi iniziali.}
}
...
\newglossaryentry{stakeholder}{
    ...
    text={stakeholder},
    sort=stakeholder,
    description={Gli \emph{stakeholder} sono tutte le persone, gruppi o organizzazioni che hanno un interesse nel progetto o che possono essere influenzati dai suoi risultati. Includono clienti, utenti finali, sponsor, management e team di sviluppo.}
}
...
\newglossaryentry{refactoring}{
    ...
    text={refactoring},
    sort=refactoring,
    description={Il \emph{refactoring} è il processo di ristrutturazione del codice esistente senza modificarne il comportamento esterno, con l'obiettivo di migliorarne la leggibilità, la manutenibilità e le prestazioni.}
}

\newglossaryentry{scorer}{
    name={Scorer},
    text={scorer},
    sort=scorer,
    description={Nel contesto del testing di LLM, uno \emph{scorer} è un modello o algoritmo utilizzato per valutare automaticamente le risposte generate da un modello target, determinando se un test è stato superato o fallito sulla base di criteri predefiniti.}
}